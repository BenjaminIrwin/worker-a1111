...
ADD reliberate_v10.safetensors /
...
COPY --from=download /reliberate_v10.safetensors /stable-diffusion-webui/models/Stable-diffuion/reliberate_v10.safetensors
...
RUN cd /stable-diffusion-webui && python cache.py --use-cpu=all --ckpt /stable-diffusion-webui/models/Stable-diffusion/reliberate_v10.safetensors
